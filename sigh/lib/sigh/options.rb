  ...
  class Options
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :app_identifier_is_prefix,
                                     short_option: "-p",
                                     env_name: "SIGH_APP_IDENTIFIER_IS_PREFIX",
                                     description: "Treat passed bundle identifier as prefix",
                                     is_string: false,
                                     optional: true,
                                     default_value: false),
        ...
        FastlaneCore::ConfigItem.new(key: :provisioning_name,
                                     ...
                                     optional: true),
        FastlaneCore::ConfigItem.new(key: :provisioning_name_is_chunk,
                                     short_option: "-k",
                                     env_name: "SIGH_PROVISIONING_PROFILE_NAME_IS_CHUNK",
                                     description: "Treat passed provisioning name as a chunk",
                                     is_string: false,
                                     optional: true,
                                     default_value: false),
        ...
        FastlaneCore::ConfigItem.new(key: :filename,
                                     ...
                                     verify_block: proc do |value|
                                       UI.user_error!("The output name must end with .mobileprovision") unless value.include?('%') || value.end_with?(".mobileprovision")
                                     end),
